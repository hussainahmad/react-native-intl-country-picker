...
export const Countries: CountriesMap = {
  ...
  TF: {
    ...
    name: {
      ...
      kor: '프랑스령 남부와 남극 지역',
      ara: 'المقاطعات الجنوبية الفرنسية',
    },
  },
  GA: {
    currency: ['XAF'],
  ...
  US: {
    ...
    name: {
      ...
      urd: 'ریاستہائے متحدہ',
      kor: '미국',
      ara: 'الولايات المتحدة الأمريكية',
    },
  },
  UM: {
    currency: ['USD'],
    ...
    name: {
      ...
      kor: '미국령 군소 제도',
      ara: 'جزر الولايات المتحدة البعيدة الصغيرة',
    },
  },
  VI: {
    currency: ['USD'],
